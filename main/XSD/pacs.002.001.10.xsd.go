...
// AccountIdentification4Choice is CT: Not Used, AE: Not Used, SC: Populated by CI Hub, CT9: Not Used, SC9: Not Used
...
type AmendmentInformationDetails13 struct {
	...
	OrgnlFnlColltnDt time.Time                                     `xml:"OrgnlFnlColltnDt"`
...
// BranchAndFinancialInstitutionIdentification6 is CT: Not used, AE: Not Used, SC: Not Used, CT9: Populated by RFI from Request, SC9: Populated by RFI from Request
...
// CashAccount38 is CT: Not Used, AE: Not Used, SC: Copied from the Credit Transfer Request's Debtor Account Type, CT9: Not Used, SC9: Not Used
...
// CashAccountType2Choice is CT: Not Used, AE: Not Used, SC: Copied from the Credit Transfer Request's Debtor Account Type, CT9: Not Used, SC9: Not Used
...
// FIToFIPaymentStatusReportV10 is x
...
// FinancialInstitutionIdentification18 is CT: Not used, AE: Not Used, SC: Not Used, CT9: Populated by RFI from Request, SC9: Populated by RFI from Request
...
// GenericAccountIdentification1 is CT: Not Used, AE: Not Used, SC: Populated from Credit Transfer Request's DbtrAcct Id by CI Hub, CT9: Not Used, SC9: Not Used
...
// GenericFinancialIdentification1 is CT: Not used, AE: Not Used, SC: Not Used, CT9: Populated by RFI from Request, SC9: Populated by RFI from Request
...
type MandateRelatedInformation14 struct {
	...
	DtOfSgntr     time.Time                      `xml:"DtOfSgntr"`
	...
	FrstColltnDt  time.Time                      `xml:"FrstColltnDt"`
	FnlColltnDt   time.Time                      `xml:"FnlColltnDt"`
...
// OriginalGroupHeader17 is CT: Not Used, AE: Not Used
...
// OriginalTransactionReference28 is CT: Not Used, AE: Populated by RFI, SC: Copied from Credit Transfer Request (if present), AE: - populated by RFI, CT9: Not Used, SC9: Not Used
type OriginalTransactionReference28 struct {
	...
	ReqdColltnDt   time.Time                                     `xml:"ReqdColltnDt"`
...
// Party40Choice is CT: Not used, AE: Not Used, SC: Not Used, CT9: Populated by RFI from Request, SC9: Populated by RFI from Request
type Party40Choice struct {
	Pty *PartyIdentification135                       `xml:"Pty"`
	Agt *BranchAndFinancialInstitutionIdentification6 `xml:"Agt"`
}

// PartyIdentification135 is CT: Not used, AE: Not Used, SC: Populated by CI Hub from Credit Transfer Request's Debtor Name. CT9: Not Used, SC9: Not Used
...
// PaymentTransaction110 is CT9: Not Used
...
// StatusReason6Choice is x
type StatusReason6Choice struct {
	Cd    string `xml:"Cd"`
	Prtry string `xml:"Prtry"`
}

// StatusReasonInformation12 is AE: Not Used, SC9: Not Used, CT9: Not Used
...
// BISupplementaryData1 is CT9: Not Used
...
// BISupplementaryDataEnvelope1 is CT: Not Used, AE: Not Used, SC and SC9: Populated by CI Hub, CT9: Not Used
...
// BIAddtlCstmrInf is CT: Not Used, AE: Not Used, SC: Populated by CI Hub, [PS: Sending Customer's Hometown], CT9: Not used, SC9: Not Used
