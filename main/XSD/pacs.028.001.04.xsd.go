...
type CreditTransferMandateData1 struct {
	...
	DtOfVrfctn   time.Time                  `xml:"DtOfVrfctn"`
	ElctrncSgntr []byte                     `xml:"ElctrncSgntr"`
	FrstPmtDt    time.Time                  `xml:"FrstPmtDt"`
	FnlPmtDt     time.Time                  `xml:"FnlPmtDt"`
...
// FIToFIPaymentStatusRequestV04 is x
