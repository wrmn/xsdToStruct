...
// AccountIdentification4Choice is Creditor Account Identification (Othr) Info group
...
// CashAccount38 is Creditor Account Proxy info group
...
// CashAccountType2Choice is TODO what account types to have for FICdtTrf?
type CashAccountType2Choice struct {
	Cd    string `xml:"Cd"`
	Prtry string `xml:"Prtry"`
}

// CategoryPurpose1Choice is Inbound field validation: this value must always be set to 99 (Others). [PS: Purpose of Transaction]
...
// CreditTransferTransaction44 is x
...
// FinancialInstitutionCreditTransferV09 is x
...
// LocalInstrument2Choice is The payment Channel identifier of the Credit Transfer - a copy of the 2-character value 'CC' in the /AppHdr/BizMsgIdr that denotes the Payment Channel (the 21st-22nd characters inclusive). (e.g. 01=Internet Banking, 02=Mobile Banking, 03=Over the Counter, 99=Other). As with the BizMsgIdr itself, this field should be set by any system that constructs a Credit Transfer message for sending
...
// PaymentIdentification13 is Settlement Cycle when the payment will be settled. This will be set by CI Hub.
...
// ProxyAccountIdentification1 is Creditor Account Proxy Identification value
type ProxyAccountIdentification1 struct {
	Tp *ProxyAccountType1Choice `xml:"Tp"`
	Id string                   `xml:"Id"`
}

// ProxyAccountType1Choice is Creditor Account Proxy Identification Type indicator, 01=Mobile Phone number, 02=Email.
