...
// BusinessApplicationHeader1 is Optional. Boolean type. If present, can have value true or 1 to indicate boolean true, or false or 0, to indicate boolean false
...
// BusinessApplicationHeaderV01 is x
