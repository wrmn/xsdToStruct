...
// BranchAndFinancialInstitutionIdentification6 is x
...
// CashAccount38 is AE: Not Used, CT: Not Used, PCT: Populated by OFI
...
// CashAccountType2Choice is AE: Not Used
type CashAccountType2Choice struct {
	Cd    string `xml:"Cd"`
	Prtry string `xml:"Prtry"`
}

// CategoryPurpose1Choice is AE: Not Used, [PS: Purpose of Transaction]
...
// CreditTransferTransaction39 is AE: Not Used
...
// FIToFICustomerCreditTransferV08 is x
...
// FinancialInstitutionIdentification18 is x
...
// GenericAccountIdentification1 is [PS: Receiving Customer's Account Number]
...
// GenericFinancialIdentification1 is [PS: Receiving Bank BIC, BIC Receiving Bank]
...
// GenericOrganisationIdentification1 is AE: Not Used, For CT: Used if Creditor is not an Individual type (in field /FIToFICstmrCdtTrf/CdtTrfTxInf/SplmtryData/Envlp/Cdtr/Tp). For CT: Inbound Field Validation: Either this field, or field /FIToFICstmrCdtTrf/CdtTrfTxInf/Cdtr/Id/PrvtId/Othr/Id Must be present, but not both
...
// GenericPersonIdentification1 is AE: Not Used, [PS: Receiving Customer's ID Number]
...
// LocalInstrument2Choice is AE: Not Used
...
// OrganisationIdentification29 is AE: Not Used - For CT: Inbound Field Validation: Either this field, or field /FIToFICstmrCdtTrf/CdtTrfTxInf/Cdtr/Id/PrvtId/Othr/Id Must be present, but not both
...
// Party38Choice is AE: Not Used, For CT: Inbound Field Validation: Either this field, or field /FIToFICstmrCdtTrf/CdtTrfTxInf/Cdtr/Id/OrgId/Othr/Id Must be present, but not both
type Party38Choice struct {
	OrgId  *OrganisationIdentification29 `xml:"OrgId"`
	PrvtId *PersonIdentification13       `xml:"PrvtId"`
}

// PartyIdentification135 is Country of Residence - Customer's Resident Status (RsdntSts) will be held in Supplementary Data section.
...
// PaymentIdentification7 is Settlement Cycle when the payment will be settled. This will be set by CI Hub.
...
// PaymentTypeInformation28 is AE: Not Used
...
// PersonIdentification13 is AE: Not Used
...
// PostalAddress24 is Debtor Postal Address Town Name (value is a city code number mapping to Customer's city)
...
// ProxyAccountIdentification1 is AE: Not Used, [PS: Mobilephone no. / Email], Inbound Field Validation: Max Length to be 140 Characters, CT: Not Used, PCT: Populated by OFI
type ProxyAccountIdentification1 struct {
	Tp *ProxyAccountType1Choice `xml:"Tp"`
	Id string                   `xml:"Id"`
}

// ProxyAccountType1Choice is AE: Not Used, CT: Not Used, PCT: Populated by OFI
...
// RemittanceInformation16 is AE: Not Used, [PS: Description], Inbound Field Validation: Optional. If present, Only allow 1 occurrence of this field in the message.
...
// BISupplementaryData1 is AE: Not Used
...
// BISupplementaryDataEnvelope1 is AE: Not Used, CT: If this CT represents a reverse CT, then this is the EndToEndId of the original CT being reversed.
type BISupplementaryDataEnvelope1 struct {
	XMLName         xml.Name         `xml:"BI_SupplementaryDataEnvelope1"`
	Dbtr            *BIAddtlCstmrInf `xml:"Dbtr"`
	Cdtr            *BIAddtlCstmrInf `xml:"Cdtr"`
	OrgnlEndtoEndId string           `xml:"OrgnlEndtoEndId"`
}

// BIAddtlCstmrInf is [PS: Sending Customer's Hometown], AE: Not Used
